...
export function previewResponse(path: string, init?: RequestInit): unknown {
  ...
  if (path.includes("/feed")) {
    ...
    const thisMonth = [
        ...
        feedItem("True Love", "Cupid Parasite", "2", { tg_id: 2, person: "Forrogmir", rarity_percent: 8.1, unlocked_at: hoursAgo(3) }),
        feedItem("Night Raid", "Dying Light: The Beast", "3", { tg_id: 3, person: "HeCnu", rarity_percent: 12, unlocked_at: hoursAgo(5) }),
        feedItem("Hidden Route", "Cupid Parasite", "4", { rarity_percent: 2.1 }),
        feedItem("Secret Boss", "Silent Hill", "5", { is_secret: true, gamerscore: 100, rarity_percent: 1.8, unlocked_at: hoursAgo(8) }),
        feedItem("Midnight Walk", "Silent Hill", "6", { is_secret: true, gamerscore: 15, rarity_percent: 22.4, unlocked_at: hoursAgo(10) }),
        feedItem("Daybreak", "Yakuza Kiwami 3", "7", { tg_id: 4, person: "P1LEDR1V3R", unlocked_at: hoursAgo(14) }),
        feedItem("First Blood", "Dying Light: The Beast", "8", { rarity_percent: 31, unlocked_at: hoursAgo(20) }),
    ];
    const lastMonth = [
