    ...
    const thisMonth = [
        ...
        feedItem("Heist Complete", "Marvel's Spider-Man", "psn1", {
          ...
          progress: {
            ...
            total: 74,
            has_dlc: true,
            group: { name: "Ограбление", unlocked: 3, total: 7, is_default: false },
          },
        }),
        feedItem("Платина", "God of War Ragnarök", "psn-plat", {
          tg_id: 6,
          person: "Mira",
          platform: "psn",
          gamerscore: 0,
          ...
          tier_badge: "💠",
          unlocked_at: hoursAgo(2),
          progress: { unlocked: 36, total: 36 },
        }),
        feedItem("Master Chief", "Halo Infinite", "xbox-100", {
          rarity_percent: 3.1,
          unlocked_at: hoursAgo(4),
          progress: { unlocked: 50, total: 50 },
        }),
        feedItem("Платина", "Horizon Forbidden West", "psn-plat2", {
          tg_id: 2,
          person: "Forrogmir",
          platform: "psn",
          gamerscore: 0,
          ...
          trophy_type: "platinum",
          tier_badge: "💠",
          unlocked_at: hoursAgo(30),
          progress: { unlocked: 79, total: 79 },
        }),
