...
Telegram-бот, который публикует ачивки участников чата — Xbox, Steam и
PlayStation Network — с фильтром по редкости, личной статистикой, ежедневным
итогом дня, админ-панелью, поиском времени прохождения игр через
HowLongToBeat. Некоммерческий проект на 20–30 человек.

Правила разработки, архитектура, текущее поведение и полное дерево файлов —
всё в [CLAUDE.md](CLAUDE.md) (на английском) — прочитай перед тем, как менять
продукт или архитектуру. Открытые задачи и предложения — в
[Issues](https://github.com/MadOmsk/xbox_achievement_bot/issues) репозитория.
...
в разделе «Operations» [CLAUDE.md](CLAUDE.md).
