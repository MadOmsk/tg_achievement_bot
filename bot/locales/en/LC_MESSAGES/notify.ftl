...
notify-service-key-alive = ✅ The shared { $label } key is working again — { $label } accounts are being polled as usual.
...
notify-translation-key-alive = ✅ The Anthropic key is working again — achievement descriptions are being translated again.
