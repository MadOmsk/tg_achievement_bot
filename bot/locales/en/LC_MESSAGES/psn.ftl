...
psn-backfill-started = Reading your PSN trophy history, this may take a couple of minutes…
psn-backfill-failed = I couldn't read back your PSN trophy history. Publishing is off for now — link the account again a little later: /connect_psn.
psn-backfill-done = Done: read back { $count } PSN trophies you'd already earned — they won't be posted to the chat.
psn-backfill-private-note = Some of your games ({ $count }) have their privacy closed — I couldn't read trophies from them. To have them counted, open the privacy setting for those games in the PS App.
