...
# Перепривязка известного аккаунта (#52): его история уже в базе, качать
# заново нечего — забираем только то, что появилось с последнего раза.
steam-catch-up-started = Этот аккаунт мне уже знаком — достижения на месте. Догоню только новое.
