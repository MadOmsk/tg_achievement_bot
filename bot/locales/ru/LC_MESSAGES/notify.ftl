...
notify-service-key-alive = ✅ Общий ключ { $label } снова работает — опрос аккаунтов { $label } продолжается.
...
notify-translation-key-alive = ✅ Ключ Anthropic снова работает — описания ачивок снова переводятся.
